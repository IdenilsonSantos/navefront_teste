...
import {
  Modal, ModalContainer, Image, Details, DetailsHeader,
  ButtonClose, DetailsInfoContainer, DetailsInfo, UserFunction, Name, Function,
  Info, Label, InfoText, DetailsActions, DeleteEditAction
} from './styles'
      ...
      <ModalConfirm openmodalconfirm={modalOpenConfirm} closemodalconfirm={closeModalConfirm} userid={userIdSelect} />
      {
        openmodal && user != null ?
          <Modal>
            <ModalContainer>
              {
                user.url !== 'test-path/image-test.png' ? <Image src={user.url} /> :
                  <Image src={NoPic} />
              }
              <Details>
                <DetailsHeader>
                ...
                <DetailsInfoContainer>
                  <DetailsInfo>
                    ...
                    <Info>
                      ...
                      <InfoText>{dateCalculateYear(user.admission_date)}</InfoText>
                    </Info>
                    <Info>
                  ...
                  <DetailsActions>
                    <DeleteEditAction onClick={() => handleDeleteEdit({ action: 'delete' }, user.id)}>
                      <Delete />
                    </DeleteEditAction>
                    <DeleteEditAction onClick={() => handleDeleteEdit({ action: 'edit' }, user.id)}>
                      <Edit />
                    </DeleteEditAction>
                  </DetailsActions>
                </DetailsInfoContainer>
